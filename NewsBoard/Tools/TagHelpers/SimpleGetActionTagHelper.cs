...
{
    [HtmlTargetElement("simpleGetAction", Attributes = ActionAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class SimpleGetActionTagHelper : TagHelper
    {
