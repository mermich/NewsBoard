...
{
    ////public class DiscoverApi : BaseAuthenticatedApi
    ////{
    ////    public DiscoverApi(int userId) : base(userId)
    ////    {
    ////    }

    ////    public DiscoverApi(User user) : base(user)
    ////    {
    ////    }
    ...
    ////        var webSite = NewsBoardContext.WebSites.FirstOrDefault(w => w.Url == syndicationContent.WebSiteUrl);
    ////        if(webSite == null)
    ////        {
    ////            webSite = new WebSite
    ////            {
