...
namespace NewBoardRestApi.Migrations
{
    ...
    [Migration("20161213181559_permissionUpdate2")]
    partial class permissionUpdate2
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("NewBoardRestApi.Model.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("NewBoardRestApi.Model.GroupPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("NewBoardRestApi.Model.UserGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("NewBoardRestApi.Model.GroupPermission", b =>
                {
                    b.HasOne("NewBoardRestApi.Model.Group", "Group")
                        .WithMany("Permissions")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("NewBoardRestApi.Model.Permission", "Permission")
